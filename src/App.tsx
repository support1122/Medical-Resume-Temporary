      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 py-6">
              ...
              >
                  ...
                  <div
                      className={`space-y-6 bg-white rounded-lg shadow-sm p-6 h-fit max-h-[800px] overflow-y-auto no-print ${
                          showOptimized ? "lg:col-span-1" : ""
                      }`}
                  >
                      <JobDescriptionInput
                      ...
                      <div className="space-y-4">
                          <div className="flex items-center gap-3">
                              <input
                                  ...
                                  onChange={(e) =>
                                      setShowPublications(e.target.checked)
                                  }
                      ...
                      <div className="space-y-4">
                          <div className="flex items-center gap-3">
                              <input
                                  ...
                                  onChange={(e) =>
                                      setShowLeadership(e.target.checked)
                                  }
                                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2"
                              />
                              <label
                  ...
                  <div
                      className={`lg:sticky lg:top-6 h-fit no-print ${
                          showOptimized ? "lg:col-span-1" : ""
                      }`}
                  >
